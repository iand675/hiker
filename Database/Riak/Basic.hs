...
module Database.Riak.Basic where
...
import Database.Riak.Protocol.SetClientIDRequest hiding (clientId)
...
run x = Riak $ ask >>= liftIO . request x 
...
index :: IndexRequest -> Riak IndexResponse
index req = do
