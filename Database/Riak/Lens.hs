...
module Database.Riak.Lens (
	...
	Database.Riak.Lens.response,
	Database.Riak.Lens.phase,
	Database.Riak.Lens.request,
	Database.Riak.Lens.buckets,
	Database.Riak.Lens.tag,
	Database.Riak.Lens.rangeMin,
	Database.Riak.Lens.rangeMax,
	Database.Riak.Lens.qtype,
	Database.Riak.Lens.serverVersion,
	Database.Riak.Lens.node,
	Database.Riak.Lens.unchanged,
	Database.Riak.Lens.notfoundOk,
	Database.Riak.Lens.ifModified,
	Database.Riak.Lens.onlyHead,
	Database.Riak.Lens.deletedVClock,
	Database.Riak.Lens.basicQuorum,
	Database.Riak.Lens.errmsg,
	Database.Riak.Lens.errcode,
	Database.Riak.Lens.rw,
	Database.Riak.Lens.vtag,
	Database.Riak.Lens.usermeta,
	Database.Riak.Lens.links,
	Database.Riak.Lens.lastModUsecs,
	Database.Riak.Lens.lastMod,
	Database.Riak.Lens.indexes,
	Database.Riak.Lens.deleted,
	Database.Riak.Lens.contentEncoding,
	Database.Riak.Lens.charset,
	Database.Riak.Lens.nVal,
	Database.Riak.Lens.allowMult,
	Database.Riak.Lens.ContentTypeValue(..),
	Database.Riak.Lens.Value(..),
	Database.Riak.Lens.KeyValue(..),
	Database.Riak.Lens.ContentValue(..),
	HasR(..),
	HasPR(..),
	HasKeys(..),
	HasContentType(..),
